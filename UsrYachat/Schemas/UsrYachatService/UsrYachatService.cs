namespace Terrasoft.Configuration
{
    ...
    public class YachatService : BaseService, IReadOnlySessionState
    {
        [OperationContract]
        ...
        public decimal GetMaxPriceByDriveTypeId(string driveTypeId)
        {
            ...
            Select select = new Select(UserConnection)
                ...
                .And("UsrStatusId").IsEqual(Column.Parameter(new Guid("cb18a280-a825-482b-a833-639ae89a5295"))) // 1. Operational
                as Select;
