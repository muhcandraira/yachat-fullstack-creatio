namespace Terrasoft.Core.Process
{
	...
	public class UsrCalcAverageTicketPriceProcessMethodsWrapper : ProcessModel
	{
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			var esq = new EntitySchemaQuery(UserConnection.EntitySchemaManager, "UsrYachat");
			var passengersCountColumn = esq.AddColumn("UsrPassengersNumber"); // SELECT UsrPassengersCount as UsrPassengersCount, UsrPrice as UsrPrice FROM UsrYacht WHERE ...
